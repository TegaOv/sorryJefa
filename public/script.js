        ...
        if (src === 'message') {
            homeDiv.innerHTML = `
                <div class="home_container">
                    <h2>Hello, There :|</h2>
                    <p>
                        I'm not maybe say the best with Words, so I made this program... <br/>
                        I'm really <span class="green">sorry</span> about my behaviour 'cause I'm a
                        <span class="green">baka</span>😂.... <br/>
                        I care about you <span class="green">Emotan</span>, that's I made this <br/>
                         <br/>
                         <br/>
                         <br/>,
                         :)
